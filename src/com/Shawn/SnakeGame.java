...
public class SnakeGame {
	...
	public final static int xPixelMaxDimension = 1001;  //Pixels in window. 501 to have 50-pixel squares plus 1 to draw a border on last square
	public final static int yPixelMaxDimension = 1001;
